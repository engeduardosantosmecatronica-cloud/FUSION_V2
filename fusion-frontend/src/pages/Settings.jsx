...
// â”€â”€ Bridge Python code â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const BRIDGE_PY = `#!/usr/bin/env python3
"""
MT5 Bridge Server â€” bridge_server.py
...
DB_PATH = "candles.db"
BUFFER_SIZE = 500  # candles por sÃ­mbolo/tf em memÃ³ria

logging.basicConfig(level=logging.INFO, format="%(asctime)s [%(levelname)s] %(message)s")
log = logging.getLogger("bridge")

# â”€â”€ In-memory buffer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ SQLite â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
def init_db():
...
# â”€â”€ WebSocket broadcast â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Named Pipe reader (Windows) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
async def read_pipe_loop():
    """LÃª mensagens JSON do EA via Named Pipe."""
...
async def process_message(msg):
    ...
    if mtype == "bar":
        ...
        if buf and buf[-1]["timestamp"] == candle["timestamp"]:
            buf[-1] = candle  # atualizaÃ§Ã£o incremental
        else:
            buf.append(candle)
...
# â”€â”€ WebSocket handler â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ FastAPI REST â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def get_candles(symbol: str, tf: str, limit: int = 200, from_ts: int = None):
    t0 = time.monotonic()
    # Primeiro tenta buffer em memÃ³ria
...
// â”€â”€ MQL5 EA code â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const EA_MQ5 = `//+------------------------------------------------------------------+
//| MT5Bridge.mq5 â€” Expert Advisor para enviar dados ao bridge      |
...
input string   Symbol_Filter = "";      // Deixe vazio para sÃ­mbolo do grÃ¡fico
...
int OnInit()
{
   ...
   if(pipe_handle == INVALID_HANDLE) {
      Print("[Bridge] AVISO: Pipe nÃ£o encontrado. Inicie bridge_server.py primeiro.");
   } else {
...
// â”€â”€ Requirements.txt â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export default function Settings() {
  ...
  const handleSave = async () => {
    ...
    if (connection) {
      await fusionLocalClient.entities.MT5Connection.update(connection.id, data);
    } else {
      await fusionLocalClient.entities.MT5Connection.create(data);
    }
  ...
  const handleClearData = async () => {
    ...
    const items = await fusionLocalClient.entities.Candle.list('created_date', 500);
    await Promise.all(items.map(c => fusionLocalClient.entities.Candle.delete(c.id)));
            ...
            <Card className="bg-[#161b22] border-[#1c2333]">
              <CardHeader className="pb-3">
                ...
                <CardDescription className="text-xs space-y-1">
                  ...
                  <p>2. Instale dependÃªncias: <code className="bg-muted px-1 rounded">pip install fastapi uvicorn websockets pywin32</code></p>
            ...
            <Card className="bg-[#161b22] border-[#1c2333]">
              <CardHeader className="pb-3">
                ...
                <CardDescription className="text-xs space-y-1">
                  ...
                  <p>3. Arraste o EA para o grÃ¡fico do ativo desejado</p>
                  <p>4. Certifique que o bridge_server.py estÃ¡ rodando antes</p>
