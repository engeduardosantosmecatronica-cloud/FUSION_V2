...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await fusionLocalClient.auth.resetPassword({ resetToken: token, newPassword: password });
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢" className="pl-9 h-9 text-sm bg-muted border-border" required />
              </div>
            </div>
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-2.5 w-4 h-4 text-muted-foreground" />
                <Input type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢" className="pl-9 h-9 text-sm bg-muted border-border" required />
              </div>
            </div>
