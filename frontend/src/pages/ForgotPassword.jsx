      ...
      <Card className="w-full max-w-sm bg-card border-border">
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription className="text-xs">
            {sent ? 'Verifique seu email' : 'Insira seu email para receber o link de recuperação'}
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {sent ? (
            <div className="text-center space-y-3">
              <p className="text-sm text-muted-foreground">Se o email existir, você receberá um link para redefinir sua senha.</p>
